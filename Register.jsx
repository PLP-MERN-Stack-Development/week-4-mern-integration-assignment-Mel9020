        ...
        <h3><Link to="/login">Login</Link></h3>
         ...
         <div className="w-full flex justify-center items-center h-[80vh]">
            <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]">
                ...
                <input className="w-full px-4 py-2 border-2 border-black outline-0" type="text" placeholder="Username" />
                ...
                <button className="w-full px-4 py-4 text-lg font-bold text-white bg-black rounded-lg hover:bg-gray-500 hover:text-back">Register</button>
